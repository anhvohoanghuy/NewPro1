...
namespace BUS.Services
{
    public class ProductBUS
    {
        ...
        public List<ProductModelView> GetAllIncludeDetail()
        {
            return productDAL.GetDataIncludeAll();
        }
        public List<ProductModelView> SearchProduct(string keySearch)
        {
            List<ProductModelView> list = GetAllIncludeDetail();
            return list.Where(x => x.ProductName.ToLower().Contains(keySearch.ToLower())).ToList();
        }
    }
}
